...
Current order: finish HUD/font blending, then Studio lighting/viewmodel,
then game audio, then optional valve_hd QA. Texture memory policy is done.
...
BYEs. Remaining HUD work is controlled font-mode/multiplicative-fade coverage
and PR/lab integration, not another chapter-title or movement validation.
...
fourth task; this reordering does not close HUD or Phase 7.
