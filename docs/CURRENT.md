...
Subsequent bounded host translation executed 95 instructions from the original
...
inside an original-game initializer (EIP 0x0101cd38). That callback has started
