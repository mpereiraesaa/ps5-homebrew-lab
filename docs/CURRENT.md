...
Subsequent bounded host translation executed 53 instructions from the original
...
at an unsupported instruction (EIP 0x01021034). CRT mode-pointer getters also
