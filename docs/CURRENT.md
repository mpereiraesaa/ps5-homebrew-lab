...
Subsequent bounded host translation executed 103 instructions from the original
...
at GetSystemTimeAsFileTime inside an original-game initializer. That callback has started
