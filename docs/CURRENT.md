...
Subsequent bounded host translation executed 129 instructions from the original
...
after completing the original initializer callback and its enclosing _initterm.
