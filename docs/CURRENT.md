...
Subsequent bounded host translation executed 335 instructions (4096-event limit) from the original
...
at LoadStringA, after GetStartupInfoA and the original initializer callback with its enclosing _initterm.
