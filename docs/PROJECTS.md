...
El traductor acotado ejecutó en host 282 instrucciones del arranque original (límite de 4096 eventos),
...
hay trece llamadas completadas a doce APIs distintas. El siguiente stop es GetStartupInfoA,
posterior al inicializador; el anidamiento de callbacks sigue validado sólo con pruebas sintéticas.
