...
El traductor acotado ejecutó en host 103 instrucciones del arranque original,
...
siguen pendientes. Se detiene en GetSystemTimeAsFileTime dentro de un callback de inicialización original,
