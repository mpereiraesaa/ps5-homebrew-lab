...
El traductor acotado ejecutó en host 329 instrucciones del arranque original (límite de 4096 eventos),
...
hay quince llamadas completadas a trece APIs distintas. GetStartupInfoA retorna y
el siguiente stop está más adelante; el anidamiento de callbacks sigue validado sólo con pruebas sintéticas.
