...
El traductor acotado ejecutó en host 351 instrucciones del arranque original (límite de 4096 eventos),
...
hay dieciséis llamadas completadas a catorce APIs distintas. GetStartupInfoA y LoadStringA retornan y
el siguiente stop es lstrlenA; el anidamiento de callbacks sigue validado sólo con pruebas sintéticas.
