...
El traductor acotado ejecutó en host 129 instrucciones del arranque original,
...
hay trece llamadas completadas a doce APIs distintas. El siguiente stop es posterior
al inicializador; el anidamiento de callbacks sigue validado sólo con pruebas sintéticas.
