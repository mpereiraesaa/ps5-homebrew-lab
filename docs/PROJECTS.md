...
El traductor acotado ejecutó en host 66 instrucciones del arranque original,
...
siguen pendientes. Se detiene en `_controlfp`, pendiente de modelar el estado FP guest.
