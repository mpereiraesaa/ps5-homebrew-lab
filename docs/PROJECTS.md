...
El traductor acotado ejecutó en host 335 instrucciones del arranque original (límite de 4096 eventos),
...
el siguiente stop es LoadStringA; el anidamiento de callbacks sigue validado sólo con pruebas sintéticas.
