...
SceAudioOut, memoria directa y threads/reloj ya cerrados. El backend de input consume lotes
...
siguiente gate es timestamp GPU end-of-pipe y latencia real de flip VideoOut.
