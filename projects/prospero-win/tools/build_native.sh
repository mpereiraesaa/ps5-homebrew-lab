...
sources=(
    ...
    src/pw_vm_posix.c src/pw_exec_probe.c src/pw_x86_block.c src/pw_x86_cache.c src/pw_x86_engine.c src/pw_guest_call.c src/pw_import_bind.c src/pw_win32.c src/pw_user32.c src/pw_crt_format.c src/pw_registry.c src/pw_guest_fp.c src/pw_guest_args.c src/pe_resource.c
)
objects=()
