...
int main(void)
{
    ...
    assert(pw_x86_cache_publish(&cache,0x2000,&second,31,&entry)==PW_ERR_LIMIT);
    assert(pw_x86_cache_publish(&cache,0x2000,&second,32,&entry)==PW_OK && cache.cursor==112);
    assert(pw_x86_cache_publish(&cache,0x3000,&first,112,&entry)==PW_ERR_LIMIT);
